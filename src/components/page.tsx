...
import { Twitter, TextIcon as Telegram, DiscIcon as Discord, RssIcon as Reddit } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-green-100">
      ...
      <footer className="bg-green-800 text-white py-6 mt-12">
        <div className="container mx-auto px-4 text-center">
          <p>&copy; 2023 CloverCoin. All rights reserved. May the luck be with you! 🍀</p>
        </div>
      </footer>
    </div>
  )
